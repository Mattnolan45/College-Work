/* CCALTokeniserTokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. CCALTokeniserTokenManager.java */
import java.io.*;
import java.util.*;

/** Token Manager. */
@SuppressWarnings("unused")public class CCALTokeniserTokenManager implements CCALTokeniserConstants {
...
static private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public CCALTokeniserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public CCALTokeniserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
