...
print("Anagrams of angle:",[w.strip() for w in lines if sorted("angle")==sorted(w.strip().lower()) and w!="angle"])
...
print("Words with most e's:",[w.strip() for w in lines if w.lower().count("e")])
